package com.xkball.xkballs_railway.client.render.tesr;
...
public class CatenaryRender extends TileEntitySpecialRenderer<CatenaryTE> {
    ...
    public static final ResourceLocation BlackTexture = new ResourceLocation(XkballRailway.MODID,"textures/block/black.png");
    @Override
