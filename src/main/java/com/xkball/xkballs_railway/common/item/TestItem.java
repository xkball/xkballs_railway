package com.xkball.xkballs_railway.common.item;

import com.xkball.xkballs_railway.XkballRailway;
import com.xkball.xkballs_railway.common.block.CatenaryBlock;
import com.xkball.xkballs_railway.common.te.CatenaryTE;
...
public class TestItem extends Item {
    ...
    public TestItem(int index){
        this.index = index;
        this.setRegistryName(new ResourceLocation(XkballRailway.MODID,"test_"+index));
